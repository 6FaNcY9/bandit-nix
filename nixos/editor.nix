{
  ...
  # Standalone nixvim package — avoids Stylix's nixvim target module entirely.
  # Stylix detects programs.nixvim in the module options and loads a broken
  # target module (infinite recursion with config.lib in options scope).
  # Using makeNixvimWithModule keeps programs.nixvim out of the option tree.
