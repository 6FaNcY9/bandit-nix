{
  # Stylix auto-generates ~/.config/Kvantum/Base16Kvantum/Base16Kvantum.kvconfig
  ...
  # (i3 focused border, kitty active tab). This overrides that one color.
  #
  # Full content is Stylix's generated output as of 2026-07-02 with only
  # highlight.color changed. link.color was already #458588 (teal) — no
  # change needed there. If Stylix regenerates other parts of this theme
  # on a future update, re-diff against the live file and re-sync this.
  xdg.configFile."Kvantum/Base16Kvantum/Base16Kvantum.kvconfig" = {
    force = true;
    text = ''
      [%General]
      ...
      window.color=#3c3836
      base.color=#282828
      alt.base.color=#3c3836
      button.color=#504945
      light.color=#665c54
      mid.light.color=#665c54
      dark.color=#282828
      mid.color=#282828
      highlight.color=#d79921
      inactive.highlight.color=#665c54
      tooltip.base.color=#282828
      text.color=#ebdbb2
      window.text.color=#ebdbb2
      button.text.color=#ebdbb2
      disabled.text.color=#928374
      tooltip.text.color=#ebdbb2
      highlight.text.color=#282828
      link.color=#458588
